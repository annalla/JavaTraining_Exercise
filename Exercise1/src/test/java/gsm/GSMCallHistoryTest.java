...
public class GSMCallHistoryTest {
    ...
    public void testGSMCallHistory() {
        ...
        if (!iphone11.addCall(call1)) System.out.println("Add Call to History failed");
        if (!iphone11.addCall(call2)) System.out.println("Add Call to History failed");
        if (!iphone11.addCall(call3)) System.out.println("Add Call to History failed");
